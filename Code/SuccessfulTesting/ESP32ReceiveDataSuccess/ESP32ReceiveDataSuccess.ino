...
void setup() {
  ...
  // Setup TX Config (Needed for ACK if you still want to send one)
...
void loop() {
  ...
  // If a packet was received in the background
  if (packetReceived) {
    ...
    // Just print the received reading
    Serial.print("Received reading value: ");
    ...
    Serial.println("Back into RX mode.");
    Radio.Rx(0);
  }
}
